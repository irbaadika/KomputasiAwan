...
@section('content')
  ...
  <div class="col-lg-4 mx-5 mt-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <form method="post" action="/sellerProduct" class="mb-5" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          <input type="hidden" class="form-control" id="seller_id" name="seller_id" value="{{ $seller->id }}">
        </div>
        <div class="mb-3">
